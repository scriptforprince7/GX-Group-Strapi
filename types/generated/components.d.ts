...
export interface CardsCustomCard extends Struct.ComponentSchema {
  collectionName: 'components_cards_custom_card';
  info: {
    description: 'A customizable card for the cards section';
  ...
  attributes: {
    ...
    featuredSubtitle: Schema.Attribute.String;
...
export interface CardsCustomCardd extends Struct.ComponentSchema {
  collectionName: 'components_cards_custom_cardds';
  info: {
    displayName: 'custom-cardd';
    icon: 'dashboard';
  };
  attributes: {
    backgroundColor: Schema.Attribute.String &
...
export interface DynamicZoneBanners extends Struct.ComponentSchema {
...
export interface DynamicZoneCardsSection extends Struct.ComponentSchema {
  collectionName: 'components_dynamic_zone_cards_section';
  info: {
    description: 'A section with customizable cards in a grid layout';
    displayName: 'Cards';
    icon: 'apps';
  };
  attributes: {
    cards: Schema.Attribute.Component<'cards.custom-card', true>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      'cards.custom-card': CardsCustomCard;
      'cards.custom-cardd': CardsCustomCardd;
      ...
      'dynamic-zone.banners': DynamicZoneBanners;
      'dynamic-zone.brands': DynamicZoneBrands;
      'dynamic-zone.cards-section': DynamicZoneCardsSection;
